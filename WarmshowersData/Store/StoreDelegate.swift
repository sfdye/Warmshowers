...
public protocol StoreDelegate {
    ...
    func retrieve<T: NSManagedObject>(inContext context: NSManagedObjectContext, withPredicate predicate: NSPredicate?, andSortBy sortBy: String?, isAscending: Bool) throws -> [T] where T: Fetchable
