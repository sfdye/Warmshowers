...
class ComposeMessageViewController: UIViewController, Delegator, DataSource {
    ...
    func configureAsNewMessage(toRecipientsWithUsernames usernames: [String]) {
        navigationItem.title = NSLocalizedString("New Message", comment: "New message view navigation bar title")
    ...
    func configureAsReply(_ threadID: Int?) {
        ...
        navigationItem.title = NSLocalizedString("Reply", comment: "Message reply view navigation bar title")
