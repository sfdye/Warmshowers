...
//        )
    ...
    func configureNavigationItem() {
        ...
        // Left button
        accountButton = UIBarButtonItem(image: UIImage.init(named: "UserIcon"), style: .Plain, target: self, action: #selector(WSHostSearchViewController.accountButtonPressed))
        navigationItem.setLeftBarButtonItem(accountButton, animated: false)
        
        // Right button
        searchButton = UIBarButtonItem(barButtonSystemItem: .Search, target: self, action: #selector(WSHostSearchViewController.searchButtonPressed))
